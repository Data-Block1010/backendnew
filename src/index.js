...
const demo_requestService_1 = require("./services/demo-requestService");
const emailService_1 = require("./services/emailService");
// Add these imports after your existing imports
const emailService = new emailService_1.EmailService();
const demoRequestService = new demo_requestService_1.DemoRequestService(emailService);
    ...
    */
    app.post('/api/companies/signup', upload.fields([
        ...
        try {
            ...
            const logo = (_a = files === null || files === void 0 ? void 0 : files.logo) === null || _a === void 0 ? void 0 : _a[0];
            const businessDocuments = (files === null || files === void 0 ? void 0 : files.businessDocuments) || [];
            ...
            await CompanyController_1.CompanyController.signup({
                name,
                website,
                email,
                integrationPurpose,
            ...
            await emailService.sendEmail(process.env.ADMIN_EMAIL || '', 'New Company Registration', `New company registration:
            - Name: ${name}
            - Website: ${website}
            - Email: ${email}
    ...
    */
    ...
    app.get('/api/companies/wallet/:walletAddress', async (req, res) => {
        try {
            ...
            await CompanyController_1.CompanyController.getCompanyByWallet(req, res);
        }
        catch (error) {
...
*/
     ...
     *         description: Internal server error
     */
    app.get('/api/waitlist/position/:email', waitListController_1.WaitlistController.getPosition);
    /**
     * @swagger
     * /api/waitlist:
     *   get:
     ...
     *         description: Internal server error
     */
    app.get('/api/waitlist', authMiddleware_1.authenticate, waitListController_1.WaitlistController.getAll);
    /**
     * @swagger
     * /api/waitlist/invite:
     *   post:
     ...
     *         description: Internal server error
     */
    app.post('/api/waitlist/invite', authMiddleware_1.authenticate, waitListController_1.WaitlistController.inviteUsers);
    /**
     * @swagger
     * /api/waitlist/{email}:
     *   delete:
     ...
     *         description: Internal server error
     */
    app.delete('/api/waitlist/:email', authMiddleware_1.authenticate, waitListController_1.WaitlistController.remove);
    /**
     * @swagger
     * components:
     *   schemas:
     ...
     *         description: Server error
     */
    app.get('/api/demo-requests', authMiddleware_1.authenticate, async (req, res) => {
        try {
            const page = parseInt(req.query.page) || 1;
            const limit = parseInt(req.query.limit) || 10;
            const status = req.query.status; // Type assertion
     ...
     *         description: Server error
     */
    app.get('/api/demo-requests/stats', authMiddleware_1.authenticate, async (req, res) => {
        try {
     ...
     *         description: Server error
     */
    app.patch('/api/demo-requests/:email/status', authMiddleware_1.authenticate, async (req, res) => {
        try {
