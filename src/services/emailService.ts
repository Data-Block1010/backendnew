...
export class EmailService {
  ...
  `;
  private readonly adminEmail = process.env.ADMIN_EMAIL || 'samelect18@gmail.com';
  private async sendAdminNotification(name: string, email: string, position: number): Promise<void> {
  ...
  async sendDemoRequestConfirmation(to: string, name: string, company: string, message?: string): Promise<void> {
