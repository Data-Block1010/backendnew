import { Request, Response } from 'express';// Adjust path as necessary
import {ProofService} from '../services/proofService'; // Adjust path as necessary
...
class ProofController {
    ...
    static async getAll(req: Request, res: Response) {
        try {
            ...
            const proofs = await ProofService.getAllProofsForUser(userId);
    ...
    static async getProofbyAddress(address: string): Promise<any> {
        try {
            console.log('Fetching proofs for user ID:', address);
            
            // Fetch proofs for the user
            const proofs = await ProofService.getProofByAddress(address);
    ...
    static async update(req: Request, res: Response) {
        try {
            ...
            const updatedProof = await ProofService.updateProof(proofId, updateData);
    ...
    static async delete(req: Request, res: Response) {
        try {
            ...
            const deletedProof = await ProofService.deleteProof(proofId);
